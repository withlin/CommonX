...
namespace CommonX.Utilities
{
    ...
    internal class ClassFactory
    {
        ...
        private ClassFactory()
        {
            ...
            //修复Net FramewWork不兼容的问题
          var assembly=AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(Guid.NewGuid().ToString()),
        ...
        Type CreateDynamicClass(DynamicProperty[] properties)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    //CreateType 被删除
                    Type result = tb.CreateTypeInfo();//NetCore使用这个
                    classCount++;
                    return result;
                }
                finally
