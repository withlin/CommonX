...
namespace CommonX.ZKClient
{
    public interface IZooKeeper
    {
        ...
        string Create(string path, object data);
        /// <summary>
        ...
        T GetData<T>(string path, IWatcher watcher, Stat stat) where T : class;
        ...
        T GetData<T>(string path, bool watch, Stat stat) where T:class ;
        ...
        /// @throws IllegalArgumentException if an invalid path is specified
        /// </summary>
        Stat SetData(string path, byte[] data, int version = -1);
        Stat SetData(string path, object data, int version = -1);
