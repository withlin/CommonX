...
namespace ZooKeeperNet
{
    ...
    public class ClientConnection : IClientConnection
    {
        ...
        //private static readonly ILogger log;// = Scope.Resolve<ILoggerFactory>().Create(typeof(ClientConnection));
        ...
        //    if (log.IsDebugOn)
        //    {
        //        log.Debug(string.Format("zookeeper.disableAutoWatchReset is {0}",disableAutoWatchReset);
        //    }
